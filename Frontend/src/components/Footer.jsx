        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-text-muted leading-relaxed max-w-sm">
              Empowering traders worldwide with professional education, cutting-edge strategies, and the psychology needed to master the markets.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-text-secondary hover:text-accent transition-colors">Refund Policy</a></li>
            </ul>
          </div>
        </div>
